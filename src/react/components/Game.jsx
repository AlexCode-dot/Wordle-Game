...
function Game() {
  const { gameState, wordLength, winningGuess, startGame, validateWin, endGame } = useGameLogic()

  return (
    <>
      {gameState === 'setup' && <GameSetup onStart={startGame} />}
      {gameState === 'playing' && <GamePlay processGuess={validateWin} wordLength={wordLength} endGame={endGame} />}
